    ...
    return (
        <AnimatePresence>
            {loading && (
                ...
                >
                    {/* Top Marquee */}
                    <div className="absolute top-8 left-0 w-full overflow-hidden text-white font-heading text-xs tracking-[0.3em] font-bold z-20 opacity-40 mix-blend-difference">
                        <motion.div
                    ...
                    <div
                        className="relative z-30 font-heading font-extrabold flex items-end text-liquid-fill leading-none tracking-tighter"
                        style={{
                    ...
                    <div className="absolute bottom-8 left-0 w-full overflow-hidden text-white font-heading text-xs tracking-[0.3em] font-bold z-20 opacity-40 mix-blend-difference">
                        <motion.div
                            className="whitespace-nowrap"
                            animate={{ x: [-1000, 0] }}
                            transition={{ repeat: Infinity, duration: 20, ease: "linear" }}
